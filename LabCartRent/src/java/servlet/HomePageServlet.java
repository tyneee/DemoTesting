...
import category.TblCategoryDAO;
...
public class HomePageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = map.get("homePageJSP");
        ...
        try {
            ...
            List<String> listAllcategory = categoryDAO.getAllCategory();
            session.setAttribute("LISTCATEGORY", listAllcategory);
